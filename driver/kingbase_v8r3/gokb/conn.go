...
import (
	...
	"github.com/team-ide/framework/driver/kingbase_v8r3/gokb/oid"
	"github.com/team-ide/framework/driver/kingbase_v8r3/gokb/scram"
)
...
func init() {
	sql.Register("kingbase-v8r3", &Driver{})
	bindDriver()
}
