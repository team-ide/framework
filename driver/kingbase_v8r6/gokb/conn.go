...
import (
	...
	"github.com/team-ide/framework/driver/kingbase_v8r6/gokb/oid"
	"github.com/team-ide/framework/driver/kingbase_v8r6/gokb/scram"
)
...
func init() {
	sql.Register("kingbase-v8r6", &Driver{})
	bindDriver()
}
